...
namespace FarmaciaWeb.Models
{
    public class Registro_Empleado
    {
        ...
        [Required(ErrorMessage = "Debe ingresar el carnet")]
        [StringLength(maximumLength:5, ErrorMessage = "El carnet debe contener 5 digitos", MinimumLength = 5)]
        public string carnet { get; set; }

        [Required(AllowEmptyStrings = false, ErrorMessage = "Debe ingresar el salario del empleado")]
